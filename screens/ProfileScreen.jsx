    ...
    const ProfileHeader = () => (
        <View style={styles.container}>
            ...
            <View style={styles.nameContainer}>
                <Text style={styles.profileName}>Mohammad Yasin</Text>
                <Text style={styles.profileHandle}>@yasin</Text>
            </View>

            <View style={styles.profileContainer}>
                <Text style={styles.profileContainerText}>Lorem ipsum, dolor sit amet consectetur, adipisicing elit. Culpa quasi tenetur, praesentium laborum.</Text>
            </View>

            <View style={styles.locationContainer}>
                <EvilIcons name="location" size={24} color="gray" />
                <Text style={styles.textGray}>Dhaka, Bangladesh</Text>
            </View>

            <View style={styles.linkContainer}>
                <TouchableOpacity
                    style={styles.linkItem}
                    onPress={() => Linking.openURL('https://mohammad-yasin.netlify.app/')}
                >
                    <EvilIcons name="link" size={24} color="gray" />
                    <Text style={styles.linkColor}>Portfolio</Text>
                </TouchableOpacity>
